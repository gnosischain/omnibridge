...
forge test --match-test test_receiveUSDCFromETH --rpc-url $GNO_RPC_URL -v
echo "ETH->GC: Done ✅"
...
forge test --match-test test_receiveUSDCFromGC --rpc-url $ETH_RPC_URL -v
echo "GC->ETH: Done ✅"
...
forge test --no-match-test test_receiveUSDCFromGC --match-path usdc_test/gno.t.sol --rpc-url $GNO_RPC_URL -v
